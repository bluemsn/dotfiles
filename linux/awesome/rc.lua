...
-- }}}
-- {{{ Commands at boot
-- Set keyboard layout to Latin American layout
awful.util.spawn_with_shell("setxkbmap -layout 'latam' -variant 'deadtilde'")
-- Startup programs
awful.util.spawn_with_shell("dropboxd &")
awful.util.spawn_with_shell("xbindkeys")
awful.util.spawn_with_shell("touchegg &")
-- }}}
beautiful.init("/home/eduan/dotfiles/linux/awesome/themes/eduan/theme.lua") -- *****
-- }}}
